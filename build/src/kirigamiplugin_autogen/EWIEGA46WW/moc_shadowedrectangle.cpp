...
QT_MOC_LITERAL(4, 46, 24), // "softwareRenderingChanged"
QT_MOC_LITERAL(5, 71, 6), // "radius"
QT_MOC_LITERAL(6, 78, 5), // "color"
QT_MOC_LITERAL(7, 84, 6), // "border"
QT_MOC_LITERAL(8, 91, 12), // "BorderGroup*"
QT_MOC_LITERAL(9, 104, 6), // "shadow"
QT_MOC_LITERAL(10, 111, 12), // "ShadowGroup*"
QT_MOC_LITERAL(11, 124, 7), // "corners"
QT_MOC_LITERAL(12, 132, 13), // "CornersGroup*"
QT_MOC_LITERAL(13, 146, 17) // "softwareRendering"

    },
    "ShadowedRectangle\0radiusChanged\0\0"
    "colorChanged\0softwareRenderingChanged\0"
    "radius\0color\0border\0BorderGroup*\0"
    "shadow\0ShadowGroup*\0corners\0CornersGroup*\0"
    "softwareRendering"
};
#undef QT_MOC_LITERAL
...
void ShadowedRectangle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->softwareRenderingChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        ...
        {
            using _t = void (ShadowedRectangle::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ShadowedRectangle::softwareRenderingChanged)) {
                *result = 2;
                return;
            }
        }
        ...
        case 5: *reinterpret_cast< bool*>(_v) = _t->isSoftwareRendering(); break;
        default: break;
        }
    } else if (_c == QMetaObject::WriteProperty) {
        auto *_t = static_cast<ShadowedRectangle *>(_o);
...
// SIGNAL 2
void ShadowedRectangle::softwareRenderingChanged()
{
